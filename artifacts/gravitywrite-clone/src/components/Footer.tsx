...
export default function Footer() {
  return (
    <footer className="border-t border-white/10 bg-background pt-20 pb-10" aria-label="Site footer">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8 mb-16">
          ...
          <nav aria-label="Product navigation">
            ...
            <ul className="space-y-3">
              <li><a href="#blog-writer" className="text-muted-foreground hover:text-white transition-colors">AI Blog Writer</a></li>
              <li><a href="#social-media-section" className="text-muted-foreground hover:text-white transition-colors">Social Media Manager</a></li>
              <li><a href="#website-developer" className="text-muted-foreground hover:text-white transition-colors">AI Website Builder</a></li>
              <li><a href="#pricing" className="text-muted-foreground hover:text-white transition-colors">Pricing Plans</a></li>
              <li><a href="#tools" className="text-muted-foreground hover:text-white transition-colors">All AI Tools</a></li>
            </ul>
          </nav>
          ...
          <nav aria-label="Resources navigation">
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-muted-foreground hover:text-white transition-colors">Tutorials</a></li>
