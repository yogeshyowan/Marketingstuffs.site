export default function TestimonialsSection() {
  const testimonials = [
    { name: "Rachel Lewis", text: "Since switching to GravityWrite, I've seen higher engagement, better SEO, and a consistent brand voice. Its writing, image, and social tools work together effortlessly." },
    { name: "Mark Thompson", text: "GravityWrite blends writing, visuals, and social content seamlessly. From content creation to image generation and scheduling—it saves hours and powers my entire workflow." },
    ...
    { name: "James Cooper", text: "From rewriting to idea generation, GravityWrite offers powerful, beginner-friendly tools for daily tasks like emails, ad copy, and content summaries. A true creative companion." },
    ...
    { name: "Sarah Mitchell", text: "GravityWrite boosts engagement, SEO, and brand consistency with powerful tools like the blog writer, image generator, and Gravity Social - all working seamlessly to drive growth." },
    { name: "Mishack Iheagwu", text: "GravityWrite simplifies work with title and blog outline generation, fast, clean article writing, allowing focus on research and editing. Great for efficiency." },
    { name: "Esther Jesudasan", text: "GravityWrite enhances writing with smart suggestions, saves time, works on various devices, offers reliable customer support, and is valuable for ed-tech content creation." }
  ];
    ...
    <section className="py-24 bg-white/[0.02] border-y border-white/5 overflow-hidden">
      <div className="container px-4 mx-auto text-center mb-16">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          Discover how content creators, marketers, and business owners are achieving breakthrough results with GravityWrite's intelligent content creation platform.
        </p>
      </div>
