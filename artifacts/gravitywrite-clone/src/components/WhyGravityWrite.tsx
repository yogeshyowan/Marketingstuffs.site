...
export default function WhyGravityWrite() {
  ...
  const tabs = [
    ...
    },
    {
      ...
      desc: "Unlike basic AI tools, GravityWrite integrates with Ahrefs, Google Analytics, WordPress to make data-driven content decisions.",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
            Why Smart Creators Choose GravityWrite
          </h2>
          <p className="text-lg text-muted-foreground mb-8">
            GravityWrite brings everything together in one intelligent platform that understands ROI, not just writing.
          </p>
